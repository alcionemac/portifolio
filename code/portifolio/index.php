...
<body>
    ...
    $projetos = [
    [
        "titulo" => "Meu Portifolio",  //TITULO
        "finalizado" => false, //FINALIZADO
        "data" => "2024-10-11", //DATA 
        "descricao" => "Meu primeiro portifolio. Escrito em PHP e HTML." //DESCRIÇÃO
    ],

    [
        "titulo" => "Lista de tarefas",  //TITULO
        "finalizado" => true, //FINALIZADO
        "data" => "2024-00-11", //DATA 
        "descricao" => "Lista de tarefas. Escrito em PHP e HTML." //DESCRIÇÃO
    ],
